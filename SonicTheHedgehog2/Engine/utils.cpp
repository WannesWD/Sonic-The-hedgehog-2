...
#pragma region CustomFunctionality

	float utils::Lerp(float value0, float value1, float lerpFactor)
	{
		return ((1.f - lerpFactor) * value0 + lerpFactor * value1);;
	}

#pragma endregion CustomFunctionality