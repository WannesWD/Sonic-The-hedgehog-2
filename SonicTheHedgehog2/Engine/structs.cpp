...
Rectf::Rectf(const Point2f& bottomLeftVertex, const Point2f& topRightVertex)
	: left{ bottomLeftVertex.x }
	, bottom{ bottomLeftVertex.y }
	, width{ topRightVertex.x - bottomLeftVertex.x }
	, height{ topRightVertex.y - bottomLeftVertex.y }
{
}
